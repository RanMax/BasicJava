package org.basicjava.virtual_filesystem.prop;
...
public class TL {
    ...
    public static void load(String lang){
        ...
        try{
            FileReader reader = new FileReader("prop/virtual_filesystem/lang/" + lang + ".properties");
		    currLang.load(reader);
		    reader.close();
            File file = new File("prop/virtual_filesystem/lang");
