 ...
 */
public class TestIterableExeption<T> implements Iterable<T> {
    private HashSet<T> innerSet;

    public TestIterableExeption(HashSet<T> set) {
        innerSet = set;
    }
    ...
    public static void main(String[] args){
        ...
        TestIterableExeption<String> i = new TestIterableExeption<String>(set);
        boolean flag = true;
        for (String str: i){
