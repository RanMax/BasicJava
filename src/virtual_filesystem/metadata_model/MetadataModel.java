package virtual_filesystem.metadata_model;

import virtual_filesystem.file_catalogs_comp.FileCatalog;
import virtual_filesystem.file_catalogs_comp.FileLocation;
import virtual_filesystem.file_catalogs_comp.VirtualFile;
...
public class MetadataModel {
    ...
    public MetadataModel(String connString){
        try{
            ...
            conn = DriverManager.getConnection("jdbc:hsqldb:hsqldb/test", "sa", "");
