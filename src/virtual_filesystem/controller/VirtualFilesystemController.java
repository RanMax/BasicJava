package virtual_filesystem.controller;

import virtual_filesystem.prop.TL;
import virtual_filesystem.containers.LangTag;
import virtual_filesystem.file_catalogs_comp.FileCatalog;
import virtual_filesystem.listeners.FileCatalogTableListener;
import virtual_filesystem.metadata_model.MetadataModel;
    ...
    private void createGui(){
        ...
        new Thread(new Runnable(){
            public void run() {
                ...
                model = new MetadataModel("jdbc:hsqldb:hsqldb/test@sa/");
